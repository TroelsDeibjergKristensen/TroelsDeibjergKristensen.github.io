...
const exp = [{
  ...
  iframe: "<iframe src='https://www.youtube.com/watch?v=Rc7QrJYl7Ys' width='640' height='380' frameborder='0' scrolling='no' allowfullscreen></iframe>",
...
const showCards2 = () => {
  ...
  exp.forEach(card => {
      $("#" + Trim(card.title)+ "toggle").click(()=>{
        $("#" + Trim(card.title)+ "content").toggle("slow", () =>{
            console.log("Animation Done");
        });
      })
      $("#" + Trim(card.title)+ "content").hide();
    }
    );
